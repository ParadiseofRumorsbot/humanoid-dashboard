  ...
  updateLog: [
    {
      ...
      changes: [
        ...
        'valuation ①: ⚠️ (4)엔터프라이즈=AIDC라 B(AI 팩토리)와 중복 가능 → 「AI 팩토리 중복차감 매출」 슬라이더 신설(기본 0). 2027E 엔터 매출 1,926십억에 AI 팩토리(연중 평균 ~70MW×150억≈1.05조)가 포함됐다면 기존 클라우드 본업이 0.88조로 2025년 대비 반토막 역성장이 되어 비현실적이므로 미포함으로 판단. 중복차감 1.05조 적용 시 Base 59.4조→54.6조(37.3만→34.3만원)',
